...
namespace estate_executor {
    ...
    int assemble_code () {
    int secret_blue = zhang::blue::code_fragment() + khan::blue::code_fragment() + garcia::blue::code_fragment();

    int secret_red = zhang::red::code_fragment() + khan::red::code_fragment() + garcia::red::code_fragment();

    return secret_blue * secret_red;
    }
}
