...
export function remainingMinutesInOven(actualMinutesInOven) {
  ...
  let minutesLeft = EXPECTED_MINUTES_IN_OVEN - actualMinutesInOven;
...
export function preparationTimeInMinutes(numberOfLayers) {
  let totalPrep = numberOfLayers * PREPARATION_MINUTES_PER_LAYER;
  return totalPrep;
}
...
export function totalTimeInMinutes(numberOfLayers, actualMinutesInOven) {
  let cookTime = preparationTimeInMinutes(numberOfLayers) + actualMinutesInOven;
  return cookTime;
}
